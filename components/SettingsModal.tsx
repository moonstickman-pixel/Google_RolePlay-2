...
import { 
  ...
  Cloud, Lock, RefreshCw, Box, Languages
} from 'lucide-react';
                                ...
                                <div>
                                    ...
                                    <div className="flex gap-2">
                                        ...
                                        <button 
                                            ...
                                            disabled={translatingField === 'userName' || !localSettings.userName}
                                            className="p-3 bg-zinc-900 border border-zinc-800 text-zinc-400 hover:text-white hover:border-orange-500/50 rounded transition-colors disabled:opacity-50"
                                            title="Translate Name"
                                        >
                                            {translatingField === 'userName' ? <Loader2 size={16} className="animate-spin" /> : <Languages size={16} />}
                                        </button>
                                    </div>
                                </div>
                                <div>
                                    ...
                                    <div className="flex flex-col gap-2">
                                        ...
                                        <div className="flex justify-end">
                                            <button 
                                                ...
                                                disabled={translatingField === 'userPersona' || !localSettings.userPersona}
                                                ...
                                                title="Translate Persona"
                                            >
                                                {translatingField === 'userPersona' ? <Loader2 size={12} className="animate-spin" /> : <Languages size={12} />}
                                                Translate
                                            </button>
                                        </div>
                                    </div>
